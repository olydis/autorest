...
export interface Polymorphism {
     ...
     * 'fishtype':'Salmon', 'location':'alaska', 'iswild':true, 'species':'king',
     ...
     * base64(FF FF FF FF FE), "siblings": [ { "fishtype": "shark", "species":
     * "predator", "birthday": "2012-01-05T01:00:00Z", "length": 20, "age": 6 }, {
     * "fishtype": "sawshark", "species": "dangerous", "picture": base64(FF FF FF
