...
namespace Fixtures.AcceptanceTestsAzureCompositeModelClient
{
    ...
    public partial interface IPolymorphismOperations
    {
        ...
        /// 'location':'alaska', 'iswild':true, 'species':'king', 'length':1.0,
        /// 'siblings':[ { 'fishtype':'Shark', 'age':6, 'birthday':
        /// '2012-01-05T01:00:00Z', 'length':20.0, 'species':'predator', }, {
        /// 'fishtype':'Sawshark', 'age':105, 'birthday':
        /// '1900-01-05T01:00:00Z', 'length':10.0, 'picture': new Buffer([255,
        /// 255, 255, 255, 254]).toString('base64'), 'species':'dangerous', },
        /// { 'fishtype': 'goblin', 'age': 1, 'birthday':
        /// '2015-08-08T00:00:00Z', 'length': 30.0, 'species': 'scary',
        /// 'jawsize': 5 } ] };
        /// </param>
        /// <param name='customHeaders'>
        /// The headers that will be added to request.
        ...
        /// should not allow this data to be sent: { "fishtype": "sawshark",
        /// "species": "snaggle toothed", "length": 18.5, "age": 2, "birthday":
        /// "2013-06-01T01:00:00Z", "location": "alaska", "picture": base64(FF
        /// FF FF FF FE), "siblings": [ { "fishtype": "shark", "species":
        /// "predator", "birthday": "2012-01-05T01:00:00Z", "length": 20,
        /// "age": 6 }, { "fishtype": "sawshark", "species": "dangerous",
        /// "picture": base64(FF FF FF FF FE), "length": 10, "age": 105 } ] }
        /// </param>
        /// <param name='customHeaders'>
        /// The headers that will be added to request.
        /// </param>
